...
# Ensure project root import when running from snapshot_utils
...
def main() -> None:
    ...
    logger.info("[ANNOTATE] Updated %s with avoid_reason (avoid_count=%d)", eval_csv, int(edf['avoid_flag'].sum()))
